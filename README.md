...
PYTHONPATH=src /usr/bin/python3 -m datagovernedforbtc.cli curated-state-5m --source-label target_2024-05-20_to_2024-06-11_with_orderbook --label target_2024-05-20_to_2024-06-11_with_orderbook_5m
...
- Curated BTC Market State 5m 聚合样本：`data_lake/features/exchange=okx/dataset_type=curated_btc_market_state/interval=5m/sample=*/curated_btc_market_state_5m.csv`
